...
void displayElements(const array<T, size>&, size_t, size_t);

template <typename T, size_t size>                              
void proj6_2a(array<T, size>&, size_t, size_t);

template <typename T, size_t size>                             
void proj6_2b(array<T, size>&, size_t, size_t, size_t, size_t);
...
template <typename T, size_t size>                              
void proj6_2a(array<T, size>& items, size_t low, size_t high) {
   ...
   if ((high - low) >= 1) { 
      ...
      proj6_2a(items, low, middle1);  
      proj6_2a(items, middle2, high);

      proj6_2b(items, low, middle1, middle2, high);
   } 
} 


template <typename T, size_t size>                             
void proj6_2b(array<T, size>& items,                              
